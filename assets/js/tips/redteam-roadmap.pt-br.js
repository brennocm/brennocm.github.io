...
{n:5,title:"Frameworks, Legal & Metodologia",extra:true,deps:[],
 ...
 sections:[
  ...
  {t:"Gestão Operacional de Red Team",items:[
   {id:"24-13",t:"Planejamento de campanha: definição de objetivos, cronograma, e matriz de comunicação (escalation matrix)",d:"f"},
   {id:"24-14",t:"Cerimônias de operação: reuniões de kickoff, check-ins de deconfliction, e debriefing",d:"i"},
   {id:"24-15",t:"Gerenciamento de artefatos: log centralizado de evidências, payloads, credenciais obtidas e hashes associados",d:"i"},
   {id:"24-16",t:"Comunicação segura com o cliente: uso de PGP, canais out-of-band, reportes parciais críticos (high-risk findings)",d:"i"},
   {id:"24-17",t:"OPSEC da própria infraestrutura: controle de acesso (IP allowlisting, MFA) ao C2 e servidores do red team",d:"a"}
  ]}
 ]},
...
{n:10,title:"Malware Dev & Evasão de EDR",extra:false,deps:[2,4,7],
 ...
 sections:[
  ...
  {t:"Evasão de EDR no Windows",items:[
  ...
  {t:"Evasão de EDR em Linux & macOS",items:[
   {id:"9-25",t:"Evasão em Linux: contornar Auditd, Falco, Sysdig, desabilitar telemetria do kernel",d:"a"},
   {id:"9-26",t:"Rootkits em eBPF: ofuscação de processos e rede sem modificar o kernel core",d:"e"},
   {id:"9-27",t:"Bypass de Gatekeeper e XProtect no macOS: manipulação de atributos estendidos (quarantine)",d:"i"},
   {id:"9-28",t:"Injeção de processos no macOS: dylib injection, task_for_pid() e bypass de entitlements",d:"a"}
  ]},
  {t:"C2 & Comunicação",items:[
   ...
   {id:"9-22",t:"C2 sobre protocolos não-HTTP: WebSocket, gRPC, e tráfego sobre HTTP/3 (QUIC)",d:"a"},
   {id:"9-23",t:"C2 sobre protocolos IoT: MQTT e CoAP em redes restritas",d:"a"},
   {id:"9-24",t:"DNS over HTTPS (DoH): uso ofensivo para esconder exfiltração de logs de DNS locais",d:"a"}
  ]}
 ]},
...
{n:12,title:"Segurança em Cloud",extra:false,deps:[3,9,11],
 ...
 sections:[
  ...
  {t:"Google Cloud Platform (GCP)",items:[
   {id:"11-15",t:"GCP IAM: Service Accounts, binding de permissões, diferença conceitual para a AWS",d:"i"},
   {id:"11-16",t:"OS Login: abuso de chaves SSH gerenciadas e metadados de instância",d:"i"},
   {id:"11-17",t:"Metadata Server do GCP: diferenças de proteção em relação ao IMDSv2 da AWS e extração de tokens de serviço",d:"i"},
   {id:"11-18",t:"GKE (Google Kubernetes Engine): Workload Identity abuse, escape de pod para controle do cluster IAM",d:"a"}
  ]},
  {t:"Serverless & Edge (Cross-Cloud)",items:[
   {id:"11-19",t:"Abuso de Serverless (AWS Lambda, Azure Functions): RCE efêmero, persistência usando funções ocultas",d:"a"},
   {id:"11-20",t:"Cloudflare Workers / Edge computing: interceptação de requisições, injeção de payloads direto no Edge",d:"a"}
  ]},
...
{n:15,title:"Engenharia Social & OSINT",extra:false,deps:[3],
 ...
 sections:[
  ...
  {t:"Malware Delivery & Initial Access",items:[
   {id:"14-13",t:"HTML Smuggling: entrega de payloads via blobs JavaScript e Data URIs evadindo proxies",d:"i"},
   {id:"14-14",t:"Bypass de MOTW (Mark-of-the-Web): ISO, IMG, LNK, VHD (técnicas clássicas e mitigadas)",d:"i"},
   {id:"14-15",t:"Malicious Documents: Macros VBA, XLM 4.0, injeção de templates remotos",d:"i"},
   {id:"14-16",t:"Scripting payloads em e-mail: HTA, JS, VBS, WSF, JSE",d:"i"},
   {id:"14-17",t:"Abuso de extensões e Right-to-Left Override (RLO) em anexos",d:"f"}
  ]}
 ]},
...
{n:17,title:"Hardware Hacking, IoT & Embedded",extra:true,deps:[1],
 desc:"Acesso físico ao dispositivo, protocolos de IoT e engenharia reversa de firmware.",
 sections:[
  ...
  {t:"IoT & Embedded Security",items:[
   {id:"16-11",t:"Protocolos IoT: MQTT, CoAP, AMQP — sniffing e injeção de pacotes",d:"i"},
   {id:"16-12",t:"Firmware analysis: extração via binwalk, emulação de arquiteturas exóticas (QEMU), identificação de backdoors",d:"a"},
   {id:"16-13",t:"Dispositivos embarcados: ataque a roteadores, câmeras IP, smart home, e dispositivos médicos",d:"i"},
   {id:"16-14",t:"Mobile/IoT gateway pivoting: comprometer o hub central para pivotar na rede interna corporativa",d:"a"}
  ]},
...
{n:18,title:"Containers, Kubernetes & Virtualization",extra:true,deps:[2,3,12],
 desc:"Container escape, ataques a K8s e quebra de fronteiras de hipervisores em ambientes modernos.",
 sections:[
  ...
  {t:"Virtualization & Hypervisor Escape",items:[
   {id:"17-12",t:"Arquitetura de Hipervisores: VMware ESXi, Hyper-V, KVM, Xen — superfície de ataque",d:"a"},
   {id:"17-13",t:"VM Escape: técnicas históricas (exploração de drivers virtuais, SVGA, dispositivos PCI emulados)",d:"e"},
   {id:"17-14",t:"VMI (Virtual Machine Introspection) Evasion: detectar se a VM está sendo inspecionada externamente pelo hypervisor",d:"e"}
  ]}
 ]},
...
{n:26,title:"Escalação de Privilégios (Taxonomia Completa)",extra:true,deps:[2,4,9],
 ...
 sections:[
  ...
  {t:"Escalação de Privilégios no macOS",items:[
   {id:"26-22",t:"Abuso de Authorization Services e exploits de sudoers locais",d:"i"},
   {id:"26-23",t:"Vulnerabilidades em XPC (XPC services e Mach ports) para execução de código privilegiado",d:"a"},
   {id:"26-24",t:"Exploração de Kernel Extensions (Kexts) e System Extensions vulneráveis",d:"a"},
   {id:"26-25",t:"Bypass de SIP (System Integrity Protection) — vetores históricos e correntes",d:"e"}
  ]},
...
{n:27,title:"Pós-Exploração & Pivoting",extra:true,deps:[2,3,9,10],
 ...
 sections:[
  ...
  {t:"Pós-Exploração no macOS",items:[
   {id:"27-15",t:"Bypass de TCC (Transparency, Consent, and Control): acessar microfone/disco sem prompt",d:"a"},
   {id:"27-16",t:"Keychain extraction: dumpar senhas salvas via security CLI ou injeção em processos",d:"a"},
   {id:"27-17",t:"Ferramentas de C2 específicas para Mac: Mythic (Poseidon/Apfell), SwiftBelt e payloads JXA",d:"i"}
  ]},
...
{n:33,title:"Evasão Avançada de Controles",extra:true,deps:[10,12,14],
 ...
 sections:[
  ...
  {t:"Zero Trust Network Access (ZTNA) & IAPs",items:[
   {id:"33-13",t:"Arquitetura ZTNA: Cloudflare Access, Zscaler (ZIA/ZPA), Google BeyondCorp",d:"i"},
   {id:"33-14",t:"Bypass de device posture: spoofing de certificados de máquina, alteração de registro para simular compliance",d:"a"},
   {id:"33-15",t:"Roubo de sessão de ZTNA: extração de cookies WARP/Zscaler e replay de sessão em máquinas não confiáveis",d:"a"},
   {id:"33-16",t:"Identificação de origens (Origin IP leak): contornar o proxy de proteção e bater direto no servidor real",d:"i"}
  ]},
  ...
  {t:"Exfiltração de Dados (Data Exfil)",items:[
   {id:"33-17",t:"Exfiltração via Cloud Storage: S3, GCS, Azure Blob — bypass de listas de domínios permitidos",d:"i"},
   {id:"33-18",t:"Exfiltração via protocolos ocultos: DNS, ICMP, HTTP POST com chunking",d:"i"},
   {id:"33-19",t:"Uso de serviços legítimos: exfiltração via GitHub, Pastebin, Slack, Teams, Notion",d:"i"},
   {id:"33-20",t:"Esteganografia em imagens e ofuscação de dados no nível do pacote",d:"a"},
   {id:"33-21",t:"Exfiltração física: BadUSB para cópia rápida em engagements presenciais",d:"i"}
  ]}
 ]},
{n:34,title:"Persistência (Taxonomia Completa)",extra:true,deps:[2,4,10],
 ...
 sections:[
  ...
  {t:"Persistência no macOS",items:[
   {id:"34-19",t:"LaunchDaemons e LaunchAgents: execução automática e níveis de privilégio",d:"i"},
   {id:"34-20",t:"Login Items e extensões de sistema maliciosas",d:"i"},
   {id:"34-21",t:"Abuso de perfis MDM: enrolar o dispositivo em um MDM atacante para persistência profunda",d:"a"},
   {id:"34-22",t:"Backdoors em aplicações (.app bundle tampering): injetar dylibs em apps frequentemente usados",d:"a"}
  ]}
 ]},
...
{n:38,title:"Nichos Avançados",extra:true,deps:[2,3],
 ...
 sections:[
  ...
  {t:"Segurança Automotiva & CAN Bus",items:[
   {id:"38-10",t:"CAN Bus: pacotes, IDs arbitrários, flooding, sniffing com can-utils",d:"i"},
   {id:"38-11",t:"UDS (Unified Diagnostic Services): leitura de memória, security access, flashing de ECU (reprogramação)",d:"a"},
   {id:"38-12",t:"Sistemas Infotainment & Telemática: QNX, Automotive Grade Linux, vetores via Wi-Fi/Bluetooth do carro",d:"e"},
   {id:"38-13",t:"Ataques RF contra key fobs: rolljam, relay attacks contra Smart Keys",d:"a"}
  ]}
 ]},
{n:39,title:"Red Teaming de IA & LLMs",extra:true,deps:[4,11,32],
 desc:"Superfície de ataque emergente e crítica. Não é ficção: empresas já expõem LLMs com acesso a dados internos e APIs reais.",
 sections:[
  {t:"Ataques a Modelos e Prompts",items:[
   {id:"39-1",t:"Prompt Injection (Direta e Indireta): jailbreaks, vazar system prompts, controle de contexto",d:"i"},
   {id:"39-2",t:"Indirect Prompt Injection via RAG: envenenar documentos internos (ex: currículos no RH) para comprometer o LLM que os lê",d:"a"},
   {id:"39-3",t:"Data Poisoning: manipular dados de fine-tuning para introduzir backdoors no modelo",d:"e"},
   {id:"39-4",t:"Model Inversion & Data Extraction: extrair PII ou dados de treinamento do modelo",d:"a"}
  ]},
  {t:"Ataques a Agentes de IA",items:[
   {id:"39-5",t:"LLM Agent Hijacking: forçar um LLM com acesso a ferramentas (plugins/APIs) a executar ações maliciosas (SSRF, RCE)",d:"a"},
   {id:"39-6",t:"Bypass de Guardrails: técnicas de ofuscação (base64, ciphers, token smuggling) para evadir filtros de segurança",d:"i"},
   {id:"39-7",t:"Framework MITRE ATLAS: mapeamento de táticas e técnicas específicas para Machine Learning",d:"i"}
  ]}
 ]},
{n:40,title:"SaaS, Workspace & Lateral Movement em Nuvem",extra:true,deps:[12,30],
 desc:"O ambiente corporativo moderno. Onde estão os e-mails, arquivos e comunicações. Comprometer o SaaS é muitas vezes o fim de jogo.",
 sections:[
  {t:"Microsoft 365 (M365)",items:[
   {id:"40-1",t:"Illicit Consent Grants: phishing de permissão OAuth para aplicativos no Entra ID",d:"i"},
   {id:"40-2",t:"Abuso de token do M365: extração de tokens JWT via PRT, manipulação com ferramentas como TokenTactics",d:"a"},
   {id:"40-3",t:"Pesquisa e exfiltração automatizada no SharePoint/OneDrive via Microsoft Graph API (GraphRunner)",d:"a"},
   {id:"40-4",t:"M365 E5 Security: como evadir os alertas padrão do Defender for Office/Cloud Apps",d:"a"}
  ]},
  {t:"Google Workspace (GWS)",items:[
   {id:"40-5",t:"Domain-Wide Delegation: abuso de contas de serviço com permissão de impersonation em todo o GWS",d:"a"},
   {id:"40-6",t:"Google Takeout e APIs do Drive para exfiltração silenciosa em massa",d:"i"},
   {id:"40-7",t:"SAML bypass e persistência via Google IdP (Identity Provider)",d:"a"}
  ]},
  {t:"Comunicação & Integrações",items:[
   {id:"40-8",t:"Slack/Teams: extração de cookies de sessão no desktop, abuso de webhooks e Slack Apps para lateral movement",d:"i"},
   {id:"40-9",t:"SaaS-to-SaaS (Third-party Apps): abuso de integrações legítimas (ex: Zapier, Salesforce) como backdoor corporativo",d:"a"}
  ]}
 ]},
{n:41,title:"Exploração de Perímetro & Network Services",extra:true,deps:[3,8,11],
 desc:"A ponte entre varredura e acesso inicial. Onde CVEs críticos são transformados em shells em infraestrutura de borda.",
 sections:[
  {t:"VPNs & Edge Appliances",items:[
   {id:"41-1",t:"Exploração de VPNs corporativas: Pulse Secure, Fortinet, Cisco AnyConnect, Palo Alto GlobalProtect",d:"i"},
   {id:"41-2",t:"Appliances de ADC e Load Balancers: Citrix NetScaler (CVE-2023-4966/CitrixBleed), F5 BIG-IP",d:"a"},
   {id:"41-3",t:"Adaptação de PoCs: modificar exploits públicos para evitar crash de serviços em produção",d:"a"}
  ]},
  {t:"Enterprise Applications",items:[
   {id:"41-4",t:"Ataques ao Microsoft Exchange: cadeias ProxyLogon, ProxyShell, ProxyNotShell e falsificação de SSRF",d:"a"},
   {id:"41-5",t:"Plataformas de Colaboração e CI/CD: exploração de Atlassian Confluence, Jira, Jenkins, GitLab",d:"i"},
   {id:"41-6",t:"File Transfer Appliances: exploração de MOVEit, GoAnywhere, Accellion FTA",d:"a"}
  ]},
