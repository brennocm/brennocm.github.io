...
{n:5,title:"Frameworks, Legal & Methodology",extra:true,deps:[],
 ...
 sections:[
  ...
  {t:"Red Team Operational Management",items:[
   {id:"24-13",t:"Campaign planning: objective definition, schedule, and escalation matrix",d:"f"},
   {id:"24-14",t:"Operation ceremonies: kickoff meetings, deconfliction check-ins, and debriefing",d:"i"},
   {id:"24-15",t:"Artifact management: centralized log of evidence, payloads, obtained credentials and associated hashes",d:"i"},
   {id:"24-16",t:"Secure client communication: PGP usage, out-of-band channels, critical partial reports (high-risk findings)",d:"i"},
   {id:"24-17",t:"Own infrastructure OPSEC: access control (IP allowlisting, MFA) to C2 and red team servers",d:"a"}
  ]}
 ]},
...
{n:10,title:"Malware Dev & EDR Evasion",extra:false,deps:[2,4,7],
 ...
 sections:[
  ...
  {t:"Linux & macOS EDR Evasion",items:[
   {id:"9-25",t:"Linux evasion: bypassing Auditd, Falco, Sysdig, disabling kernel telemetry",d:"a"},
   {id:"9-26",t:"eBPF rootkits: process and network obfuscation without modifying the kernel core",d:"e"},
   {id:"9-27",t:"Gatekeeper and XProtect bypass on macOS: extended attributes manipulation (quarantine)",d:"i"},
   {id:"9-28",t:"macOS process injection: dylib injection, task_for_pid() and entitlements bypass",d:"a"}
  ]},
  {t:"C2 & Communication",items:[
   ...
   {id:"9-22",t:"C2 over non-HTTP protocols: WebSocket, gRPC, and traffic over HTTP/3 (QUIC)",d:"a"},
   {id:"9-23",t:"C2 over IoT protocols: MQTT and CoAP in restricted networks",d:"a"},
   {id:"9-24",t:"DNS over HTTPS (DoH): offensive use to hide exfiltration from local DNS logs",d:"a"}
  ]}
 ]},
...
{n:12,title:"Cloud Security",extra:false,deps:[3,9,11],
 ...
 sections:[
  ...
  {t:"Google Cloud Platform (GCP)",items:[
   {id:"11-15",t:"GCP IAM: Service Accounts, permissions binding, conceptual differences from AWS",d:"i"},
   {id:"11-16",t:"OS Login: abuse of managed SSH keys and instance metadata",d:"i"},
   {id:"11-17",t:"GCP Metadata Server: protection differences from AWS IMDSv2 and service token extraction",d:"i"},
   {id:"11-18",t:"GKE (Google Kubernetes Engine): Workload Identity abuse, pod escape for IAM cluster control",d:"a"}
  ]},
  {t:"Serverless & Edge (Cross-Cloud)",items:[
   {id:"11-19",t:"Serverless abuse (AWS Lambda, Azure Functions): ephemeral RCE, persistence using hidden functions",d:"a"},
   {id:"11-20",t:"Cloudflare Workers / Edge computing: request interception, payload injection directly at the Edge",d:"a"}
  ]},
...
{n:15,title:"Social Engineering & OSINT",extra:false,deps:[3],
 ...
 sections:[
  ...
  {t:"Malware Delivery & Initial Access",items:[
   ...
   {id:"14-17",t:"Extension abuse and Right-to-Left Override (RLO) in attachments",d:"f"}
  ]}
 ]},
...
{n:17,title:"Hardware Hacking, IoT & Embedded",extra:true,deps:[1],
 desc:"Physical device access, IoT protocols and firmware reverse engineering.",
 sections:[
  ...
  {t:"IoT & Embedded Security",items:[
   {id:"16-11",t:"IoT protocols: MQTT, CoAP, AMQP — packet sniffing and injection",d:"i"},
   {id:"16-12",t:"Firmware analysis: extraction via binwalk, exotic architecture emulation (QEMU), backdoor identification",d:"a"},
   {id:"16-13",t:"Embedded devices: attacking routers, IP cameras, smart home, and medical devices",d:"i"},
   {id:"16-14",t:"Mobile/IoT gateway pivoting: compromising the central hub to pivot into the internal corporate network",d:"a"}
  ]},
...
{n:18,title:"Containers, Kubernetes & Virtualization",extra:true,deps:[2,3,12],
 desc:"Container escape, K8s attacks and breaking hypervisor boundaries in modern environments.",
 sections:[
  ...
  {t:"Virtualization & Hypervisor Escape",items:[
   {id:"17-12",t:"Hypervisor Architecture: VMware ESXi, Hyper-V, KVM, Xen — attack surface",d:"a"},
   {id:"17-13",t:"VM Escape: historical techniques (virtual driver exploitation, SVGA, emulated PCI devices)",d:"e"},
   {id:"17-14",t:"VMI (Virtual Machine Introspection) Evasion: detecting if the VM is being inspected externally by the hypervisor",d:"e"}
  ]}
 ]},
...
{n:26,title:"Privilege Escalation (Full Taxonomy)",extra:true,deps:[2,4,9],
 ...
 sections:[
  ...
  {t:"macOS Privilege Escalation",items:[
   {id:"26-22",t:"Authorization Services abuse and local sudoers exploits",d:"i"},
   {id:"26-23",t:"XPC vulnerabilities (XPC services and Mach ports) for privileged code execution",d:"a"},
   {id:"26-24",t:"Exploitation of vulnerable Kernel Extensions (Kexts) and System Extensions",d:"a"},
   {id:"26-25",t:"SIP (System Integrity Protection) bypass — historical and current vectors",d:"e"}
  ]},
...
{n:27,title:"Post-Exploitation & Pivoting",extra:true,deps:[2,3,9,10],
 ...
 sections:[
  ...
  {t:"macOS Post-Exploitation",items:[
   {id:"27-15",t:"TCC (Transparency, Consent, and Control) bypass: accessing microphone/disk without prompt",d:"a"},
   {id:"27-16",t:"Keychain extraction: dumping saved passwords via security CLI or process injection",d:"a"},
   {id:"27-17",t:"Mac-specific C2 tools: Mythic (Poseidon/Apfell), SwiftBelt and JXA payloads",d:"i"}
  ]},
...
{n:33,title:"Advanced Control Evasion",extra:true,deps:[10,12,14],
 ...
 sections:[
  ...
  {t:"Zero Trust Network Access (ZTNA) & IAPs",items:[
   {id:"33-13",t:"ZTNA Architecture: Cloudflare Access, Zscaler (ZIA/ZPA), Google BeyondCorp",d:"i"},
   {id:"33-14",t:"Device posture bypass: machine certificate spoofing, registry alteration to simulate compliance",d:"a"},
   {id:"33-15",t:"ZTNA session hijacking: WARP/Zscaler cookie extraction and session replay on untrusted machines",d:"a"},
   {id:"33-16",t:"Origin IP leak: bypassing the protection proxy and hitting the real server directly",d:"i"}
  ]},
  ...
  {t:"Data Exfiltration (Data Exfil)",items:[
   {id:"33-17",t:"Cloud Storage Exfiltration: S3, GCS, Azure Blob — allowed domains list bypass",d:"i"},
   {id:"33-18",t:"Exfiltration via covert protocols: DNS, ICMP, HTTP POST with chunking",d:"i"},
   {id:"33-19",t:"Use of legitimate services: exfiltration via GitHub, Pastebin, Slack, Teams, Notion",d:"i"},
   {id:"33-20",t:"Image steganography and data obfuscation at the packet level",d:"a"},
   {id:"33-21",t:"Physical exfiltration: BadUSB for rapid copying in physical engagements",d:"i"}
  ]}
 ]},
{n:34,title:"Persistence (Full Taxonomy)",extra:true,deps:[2,4,10],
 ...
 sections:[
  ...
  {t:"macOS Persistence",items:[
   {id:"34-19",t:"LaunchDaemons and LaunchAgents: automatic execution and privilege levels",d:"i"},
   {id:"34-20",t:"Login Items and malicious system extensions",d:"i"},
   {id:"34-21",t:"MDM profile abuse: enrolling the device in an attacker MDM for deep persistence",d:"a"},
   {id:"34-22",t:"Backdoors in applications (.app bundle tampering): injecting dylibs into frequently used apps",d:"a"}
  ]}
 ]},
...
{n:38,title:"Advanced Niches",extra:true,deps:[2,3],
 ...
 sections:[
  ...
  {t:"Automotive Security & CAN Bus",items:[
   {id:"38-10",t:"CAN Bus: packets, arbitrary IDs, flooding, sniffing with can-utils",d:"i"},
   {id:"38-11",t:"UDS (Unified Diagnostic Services): memory reading, security access, ECU flashing (reprogramming)",d:"a"},
   {id:"38-12",t:"Infotainment & Telematics Systems: QNX, Automotive Grade Linux, vectors via car Wi-Fi/Bluetooth",d:"e"},
   {id:"38-13",t:"RF attacks against key fobs: rolljam, relay attacks against Smart Keys",d:"a"}
  ]}
 ]},
{n:39,title:"AI & LLM Red Teaming",extra:true,deps:[4,11,32],
 desc:"Emerging and critical attack surface. Not fiction: enterprises already expose LLMs with access to internal data and real APIs.",
 sections:[
  {t:"Model and Prompt Attacks",items:[
   {id:"39-1",t:"Prompt Injection (Direct and Indirect): jailbreaks, leaking system prompts, context control",d:"i"},
   {id:"39-2",t:"Indirect Prompt Injection via RAG: poisoning internal documents (e.g., HR resumes) to compromise the reading LLM",d:"a"},
   {id:"39-3",t:"Data Poisoning: manipulating fine-tuning data to introduce backdoors in the model",d:"e"},
   {id:"39-4",t:"Model Inversion & Data Extraction: extracting PII or training data from the model",d:"a"}
  ]},
  {t:"AI Agent Attacks",items:[
   {id:"39-5",t:"LLM Agent Hijacking: forcing an LLM with tool access (plugins/APIs) to execute malicious actions (SSRF, RCE)",d:"a"},
   {id:"39-6",t:"Guardrail Bypass: obfuscation techniques (base64, ciphers, token smuggling) to evade security filters",d:"i"},
   {id:"39-7",t:"MITRE ATLAS Framework: mapping of ML-specific tactics and techniques",d:"i"}
  ]}
 ]},
{n:40,title:"SaaS, Workspace & Cloud Lateral Movement",extra:true,deps:[12,30],
 desc:"The modern enterprise environment. Where the emails, files, and communications actually are. Compromising SaaS is often endgame.",
 sections:[
  {t:"Microsoft 365 (M365)",items:[
   {id:"40-1",t:"Illicit Consent Grants: OAuth permission phishing for Entra ID applications",d:"i"},
   {id:"40-2",t:"M365 token abuse: JWT token extraction via PRT, manipulation with tools like TokenTactics",d:"a"},
   {id:"40-3",t:"Automated search and exfiltration in SharePoint/OneDrive via Microsoft Graph API (GraphRunner)",d:"a"},
   {id:"40-4",t:"M365 E5 Security: how to evade default Defender for Office/Cloud Apps alerts",d:"a"}
  ]},
  {t:"Google Workspace (GWS)",items:[
   {id:"40-5",t:"Domain-Wide Delegation: abuse of service accounts with impersonation permissions across GWS",d:"a"},
   {id:"40-6",t:"Google Takeout and Drive APIs for silent mass exfiltration",d:"i"},
   {id:"40-7",t:"SAML bypass and persistence via Google IdP (Identity Provider)",d:"a"}
  ]},
  {t:"Communication & Integrations",items:[
   {id:"40-8",t:"Slack/Teams: session cookie extraction on desktop, abuse of webhooks and Slack Apps for lateral movement",d:"i"},
   {id:"40-9",t:"SaaS-to-SaaS (Third-party Apps): abuse of legitimate integrations (e.g., Zapier, Salesforce) as corporate backdoors",d:"a"}
  ]}
 ]},
{n:41,title:"Perimeter Exploitation & Network Services",extra:true,deps:[3,8,11],
 desc:"The bridge between scanning and initial access. Where critical CVEs turn into shells on edge infrastructure.",
 sections:[
  {t:"VPNs & Edge Appliances",items:[
   {id:"41-1",t:"Enterprise VPN exploitation: Pulse Secure, Fortinet, Cisco AnyConnect, Palo Alto GlobalProtect",d:"i"},
   {id:"41-2",t:"ADC and Load Balancer Appliances: Citrix NetScaler (CVE-2023-4966/CitrixBleed), F5 BIG-IP",d:"a"},
   {id:"41-3",t:"PoC adaptation: modifying public exploits to prevent crashing production services",d:"a"}
  ]},
  {t:"Enterprise Applications",items:[
   {id:"41-4",t:"Microsoft Exchange attacks: ProxyLogon, ProxyShell, ProxyNotShell chains and SSRF forging",d:"a"},
   {id:"41-5",t:"Collaboration and CI/CD platforms: exploitation of Atlassian Confluence, Jira, Jenkins, GitLab",d:"i"},
   {id:"41-6",t:"File Transfer Appliances: exploitation of MOVEit, GoAnywhere, Accellion FTA",d:"a"}
  ]},
